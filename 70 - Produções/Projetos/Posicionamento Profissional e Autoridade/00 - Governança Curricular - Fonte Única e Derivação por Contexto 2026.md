...
A fonte única para reconstrução detalhada do percurso é:

> [[22 - Matriz Curricular Detalhada - Eixos Datas Cargas e Evidências 2026]]

A matriz deve ser consultada antes de:

- responder perguntas sobre formação;
- produzir ou revisar currículo;
- produzir mini bio;
- preparar página de site;
- preparar apresentação, palestra ou proposta institucional;
- elaborar Lattes, ORCID ou bibliografia;
- responder sobre diplomas e certificados;
- resumir a trajetória em materiais de marketing;
- criar qualquer texto sobre a persona profissional.

# Hierarquia das fontes

## 1. Matriz curricular detalhada — fonte de conteúdo

[[22 - Matriz Curricular Detalhada - Eixos Datas Cargas e Evidências 2026]]

Contém a relação detalhada das formações, datas, cargas horárias, instituições, professores, documentos, duplicatas, estados de comprovação e formulações canônicas.

## 2. Matriz de evidências — fonte de natureza documental

[[03 - Formação, Evidências e Fontes Documentais]]

Define se cada informação é documental, autobiográfica, combinada, histórica ou uma questão de precisão específica.

## 3. Auditorias e dossiês — fontes primárias de conferência
...
## 4. Currículo narrativo derivado
...
Essas notas são derivações da matriz e devem ser atualizadas quando a matriz mudar.

## 5. Bios e versões de comunicação

- [[05 - Versões Públicas de Bio e Currículo]]

Esta nota é a fonte vigente para bios por contexto. Ela não deve receber informações incompatíveis com a matriz detalhada.

# Formulações obrigatórias vigentes
...
Não reduzir a informação a “formação em Psicologia Transpessoal” quando o contexto exigir o currículo ampliado.
...
- Mirroring Hands — 12h, 07–08/12/2019;
...
> **Professor, palestrante e facilitador em cursos livres e educação continuada.**

Qualificar a função por projeto ou evento. Não converter aula convidada na PUC-SP em vínculo docente regular e não converter a Venia Docente do CEMETC em vínculo universitário brasileiro.

# Regras para resolver divergências

1. Correção explícita posterior de Fabiano prevalece sobre formulação anterior produzida por IA.
2. A matriz detalhada prevalece sobre qualquer resumo.
3. Uma nota histórica pode ser preservada, mas deve ser marcada como histórica e não pode servir de fonte para nova produção.
4. Se uma nota derivada divergir da matriz, a nota derivada deve ser corrigida.
5. Um documento confirma literalidade, data, carga ou natureza; não apaga automaticamente uma informação autobiográfica confirmada.
6. Uma matrícula comprova ingresso, não conclusão.
7. Uma credencial com validade encerrada permanece como marco histórico, mas não deve ser anunciada como vigente.
8. Cargas de módulos, níveis, duplicatas e certificados gerais não devem ser somadas sem análise de sobreposição.
9. Formação, supervisão, experiência clínica, docência, vínculo institucional e produção acadêmica devem permanecer em categorias distintas.
10. Todas as respostas futuras devem indicar a natureza da fonte quando isso for relevante.

# Status de itens essenciais

- Psicologia Transpessoal: concluída em 2010; TCC entregue; certificado emitido em 2011.
- Duas formações em Psicanálise Integrativa: confirmadas por fonte autobiográfica e documentos complementares.
- Practitioner anterior em PNL pela SBPNL: confirmado por fonte autobiográfica; separado dos certificados do Trivium.
- Hipnose clínica e terapêutica: formação e estudos explicitamente registrados, com professores e datas disponíveis.
...
- CRP 06/98630: registro profissional confirmado por Fabiano como ativo e regular.

# Fluxo de atualização

Quando surgir uma nova informação:

1. identificar se é formação, documento, experiência, docência, supervisão, produção ou vínculo;
2. registrar o dado na matriz [[22 - Matriz Curricular Detalhada - Eixos Datas Cargas e Evidências 2026]];
3. registrar ou corrigir sua natureza em [[03 - Formação, Evidências e Fontes Documentais]];
4. atualizar o dossiê documental específico, quando houver documento;
5. atualizar o índice [[12 - Documentos Comprobatórios/00 - Índice de Diplomas e Certificados]];
6. revisar [[15 - Currículo Profissional Consolidado 2026]];
7. revisar [[18 - Currículo Profissional Ampliado Consolidado - Versão Pública 2026]];
...
> Consulte primeiro [[00 - Governança Curricular — Fonte Única e Derivação por Contexto]] e depois [[22 - Matriz Curricular Detalhada - Eixos Datas Cargas e Evidências 2026]]. Use os dossiês documentais apenas para conferir literalidade, datas, cargas e natureza dos registros. Derive a resposta conforme o contexto solicitado e não use notas históricas ou bios antigas como fonte primária.
