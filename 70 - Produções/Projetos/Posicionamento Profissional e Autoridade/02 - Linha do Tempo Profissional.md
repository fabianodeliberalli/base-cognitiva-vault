...
Esta cronologia distingue datas documentalmente sustentadas de datas fornecidas por memória. Quando o ano não está confirmado, ele é mantido como aproximação e não deve ser publicado como fato fechado.

# Linha do tempo

## Início dos anos 1990

- Início da formação na Escola Oriental de Massagem e Acupuntura — EOMA.
- Início dos atendimentos ainda durante o curso, segundo relato de Fabiano.
- A trajetória no cuidado terapêutico passa a ser contínua a partir desse período.
- Formulação pública segura em 2026: **mais de 30 anos de trajetória no cuidado terapêutico**.
...
- Curso de Acupuntura Tradicional Chinesa no CEMETRAC, com 1.200 horas.
- Monografia mencionada no currículo de 2026: *Um estudo da relação mente/corpo/espírito na Medicina Tradicional Chinesa*.

## Anos 2000

- Continuidade de estudos em Medicina Tradicional Chinesa na Pró-Salus Vitae.
- Formações em Qi Gong e tradições corporais taoistas.
- Aula eventual como professor convidado na PUC-SP sobre corpo e energia; data a localizar.
- Ingresso na graduação em Psicologia da Universidade São Marcos.
...
- Estudo presencial com Mário Salvador em Brasília; ano ainda sujeito a confirmação.
- Início da colaboração com Gilda Moura em turma presencial realizada no Centralma, em 2018/2019, como professor assistente.
...
- Consolidação do projeto de posicionamento profissional e autoridade pública.

# Leitura longitudinal

A trajetória não deve ser comunicada como sucessão de abandonos. Cada etapa acrescentou uma camada:

- práticas corporais: experiência incorporada;
- MTC: percepção sistêmica e relação corpo-ambiente;
- Psicanálise: escuta, conflito, história e simbolização;
- Psicologia Transpessoal: espiritualidade, estados e desenvolvimento;
- trauma: segurança, regulação e integração;
- neurociência: exame de mecanismos e limites de inferência;
- fenomenologia: descrição do vivido;
