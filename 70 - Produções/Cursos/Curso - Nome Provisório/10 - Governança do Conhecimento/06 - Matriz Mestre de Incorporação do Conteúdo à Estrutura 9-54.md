...
# Matriz Mestre de Incorporação do Conteúdo à Estrutura 9/54
...
| UC 0.2 — O percurso do EIXO: mapa, espiral, pêndulo e segurança | M1.7 Perder o eixo não significa perder o percurso | M3.7 recursos de retorno; M6.5 Tradução/EIXO em espiral; M8.2 continuidade | conteúdo consolidado em v1.1; liberado para derivação audiovisual |
...
| UC 2.2 — Retornar é uma capacidade: sinais, apoio, dosagem e recuperação | M3.1 a M3.4 e M3.7 | retornos em M6.5 e M8.2 | arquitetura aprovada; conteúdo a desenvolver |
| UC 3.1 — Perceber, observar e diferenciar | M4.1 a M4.3 e M4.6 | diferenciação transversal | arquitetura aprovada; conteúdo a desenvolver |
| UC 3.2 — Padrões, partes, relações e contexto | M4.4 a M4.6 | caso composto: eco conceitual em M4.4 | arquitetura aprovada; conteúdo a desenvolver |
| UC 4.1 — Coordenação interna, valores e orientação | M5.1 a M5.5 | Três Eus, símbolos e valores | arquitetura aprovada; conteúdo a desenvolver |
| UC 4.2 — Espiritualidade, experiência e EIXO | M5.6 a M5.8 | espiritualidade explícita e longitudinal | arquitetura aprovada; conteúdo a desenvolver |
| UC 5.1 — Integrar sem apagar diferenças | M6.1 a M6.4 | pluralismo e integração funcional | arquitetura aprovada; conteúdo a desenvolver |
| UC 5.2 — Tradução e EIXO em espiral | M6.5 e M6.6 | retornos a M1.7, M3.7 e M8.2 | arquitetura aprovada; conteúdo a desenvolver |
| UC 6.1 — Expressar com coerência: vínculos, limites e contribuição | M7.1 a M7.6 | aplicações relacionais | arquitetura aprovada; conteúdo a desenvolver |
| UC 6.2 — Reparar, aprender e continuar | M7.7 e M7.8; M8.1 a M8.3 | plano de continuidade e comunidade | arquitetura aprovada; conteúdo a desenvolver |

## Ativos prioritários já localizados

| Ativo | Estatuto de origem | Destino na 9/54 | Tratamento |
|---|---|---|---|
| Sete Partes e quatro macroblocos da UC 0.1 | consolidado v1.0 | M1.1–M1.6 | preservar arco e redistribuir sem perda de sentido |
...
Ao consolidar uma aula da estrutura 9/54, acrescentar ou atualizar uma linha com:
...
| M1.7 — Perder o eixo não significa perder o percurso | reconhecer que estado, acesso e coordenação oscilam sem apagar referência e percurso | UC 0.2; consolidação v1.1; mapas aprovados | três níveis; pêndulo e espiral; responsabilidade situada | experiência preditiva, corpo, memória, contexto, regulação e pluralismo | dois mapas centrais; prática Reconhecer para retornar; cartão | Desenvolvimento do Retorno em M3.7/M6.5/M8.2; Três Perspectivas no bastidor | conteúdo consolidado; derivação audiovisual liberada; gravação pendente |

## Critério de completude

Uma aula não precisa consumir todo o patrimônio relacionado. Ela precisa demonstrar que o material relevante recebeu destino consciente. Uma unidade ou ativo não é considerado integrado apenas porque foi citado: sua função na aula, no fundamento, no recurso, no aprofundamento, na reserva ou na exclusão deve estar clara.
...
Documento operacional: [[00 - Estado e Continuidade da Produção M1]]. O Orquestrador não produz nem aprova conteúdo curricular.
