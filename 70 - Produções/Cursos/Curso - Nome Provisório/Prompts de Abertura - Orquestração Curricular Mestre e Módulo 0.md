...
## Diretriz obrigatória para qualquer novo chat
...
A consolidação e a auditoria formal só começam quando eu disser que a aula representa suficientemente o que desejo ensinar, ou quando for necessário preparar uma versão para pilotagem.
```
