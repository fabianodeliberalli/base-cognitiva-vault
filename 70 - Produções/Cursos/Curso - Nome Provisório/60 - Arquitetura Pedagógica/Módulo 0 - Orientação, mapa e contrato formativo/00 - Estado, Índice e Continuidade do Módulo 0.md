...
Em 26 de julho de 2026 foram produzidos um Relatório de Retomada e uma Matriz de Inventário e Auditoria Curricular da Aula 0.1.

Esses materiais localizaram o acervo e levantaram tensões úteis, mas suas classificações e recomendações não constituem decisões. Permanecem como leitura consultiva preliminar.

Em especial, não está decidido antecipadamente:

- que Tradução deva ocupar apenas uma função breve;
- que multidimensionalidade ou Cinco Janelas devam ser retiradas;
- que conteúdos tenham destino definitivo em Aulas 1.1 ou 1.2;
...
- nenhum material anterior será apagado;
- novas perspectivas podem ser incorporadas;
- a Aula 0.2 pode iluminar a 0.1 sem impor seu fechamento;
- decisões que afetem o curso inteiro serão anotadas e reconciliadas em marco oportuno, sem interromper a criação;
