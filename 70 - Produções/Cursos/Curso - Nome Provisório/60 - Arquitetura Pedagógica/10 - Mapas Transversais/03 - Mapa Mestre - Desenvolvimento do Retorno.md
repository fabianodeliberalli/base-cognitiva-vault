---
tipo: mapa-transversal-e-instrumento-formativo
...
```mermaid
flowchart TD
    A["Perceber mais cedo"]
    B["Sustentar ou recuperar presença"]
    C["Diferenciar a experiência"]
    D["Orientar resposta, apoio e limite"]
    E["Considerar efeitos, reparar e aprender"]
