---
tipo: roteiro-integral-recuperado
...
estado_maturidade: montagem-integral-recuperada-nao-revisada
versao: "0.1"
...
- as versões literais mais recentes identificadas das Partes 1–5;
- as Partes 6–7 da proposta v0.4 já registrada no repositório.

Esta montagem **não combina redações dentro de uma mesma Parte**, não corrige o texto recuperado, não declara compatibilidade final entre as Partes e não autoriza gravação. Sua finalidade é permitir a leitura integral de Fabiano e, depois, a revisão Parte por Parte e transversal.

## Conflitos visíveis que permanecem para revisão

- títulos internos das Partes 1–5 ainda usam “Capítulo”, conforme o texto original recuperado;
- a numeração de slides precisa ser conferida na junção entre as Partes 5 e 6;
- as transições 5→6 e 6→7 precisam ser lidas no conjunto;
- repetições, duração, densidade e fronteiras com as Aulas 0.2, 1.1 e 1.2 ainda não foram editadas;
- as Partes 6–7 permanecem proposta v0.4 em leitura autoral.

---

# BLOCO RECUPERADO — PARTES 1–5
...
# BLOCO VIGENTE DE TRABALHO — PARTES 6–7 v0.4
