...
```mermaid
flowchart TD
    A["Já compreendi muito"] --> B["Ainda não consigo acessar"]
    B --> C["Compreensão não é disponibilidade"]
    C --> D["Disponibilidade pode crescer"]
    D --> E["Sem transformar o percurso em cobrança"]
```
