---
tipo: montagem-literal-recuperada
...
estado_maturidade: texto-literal-recuperado-nao-aprovado
versao: "0.1"
...
- **Fonte primária:** [[Transcrição integral - Elaboração das Partes 1 a 5 - Aula 0.1]];
- **critério:** última formulação integral de cada Parte após as intervenções do autor;
- **estatuto:** fonte de trabalho para leitura autoral; não equivale a aprovação;
- **preservação:** os títulos internos ainda usam “Capítulo” porque essa era a redação literal no momento da elaboração. A decisão posterior de usar “Parte” será aplicada somente quando houver edição autorizada;
- **exclusões:** mensagens de análise, versões substituídas e intervenções foram preservadas na transcrição integral, mas não duplicadas nesta montagem.

## Sucessão identificada

| Escopo | Versão selecionada | Motivo documental |
|---|---|---|
| Partes 1–2 | reformulação ampliada posterior à discussão sobre Damasio | é a última redação integral e incorpora as duas portas de entrada |
| Parte 3 | “A experiência é maior do que qualquer explicação” | versão integral posterior às Partes 1–2 |
| Parte 4 | “Como vamos percorrer este caminho” | substitui a formulação anterior “O Contrato de Tradução” após objeção autoral |
| Parte 5 | “Da manifestação à primeira cartografia” | versão integral única e mais recente |
