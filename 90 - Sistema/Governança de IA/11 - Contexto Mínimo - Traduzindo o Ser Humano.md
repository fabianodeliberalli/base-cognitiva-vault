...
Use esta ficha para começar. Expanda a leitura somente conforme a tarefa.

## Decisões estruturantes vigentes
...
- Fabiano é a única autoridade para aprovar, rejeitar ou alterar decisões autorais.

## Estado operacional resumido

- Memória persistente: este repositório GitHub sincronizado com o Obsidian.
- Produção curricular oficial deve ocorrer na frente ativa de M1.1–M1.7.
- UC 0.1 está encerrada curricularmente em v1.0; audiovisual e gravação permanecem etapas distintas.
- UC 0.2/M1.7 está consolidada como fonte para derivação audiovisual, sem autorização automática de gravação.
- Aula 1.1 permanece protótipo revisável, sem proteção canônica.
- Quando este resumo divergir de registro posterior homologado, prevalece o registro homologado dentro de seu escopo.
