...
# Decisões recuperadas dos chats após o baseline

Este registro não transforma automaticamente toda fala de chat em regra do vault. Ele separa decisões confirmadas, estado de artefatos e conflitos que exigem mediação.

## Confirmado por Fabiano em 06/09/2026

### Comunicação e formulário

- Preferência por resultado desejado mais curto.
- Formulação aprovada: **“Perceber o automático mais cedo, recuperar clareza e responder com mais coerência”.**
- Formulação aprovada para substituir linguagem de aquisição: **“Entender um padrão nem sempre basta para responder de outro modo”.**
- Remover do briefing o tempo de formação e a indicação de “estágio novo do produto”.
- Não explicitar estágio de produção nem bloco técnico nessa comunicação.
- Autoridade sem a formulação “atendimentos clínicos de resultado”.
- Página 16 centrada em aquisição, resultado, Tradução, corpo, emoções, história, contexto, relações, consciência e espiritualidade.
- Nome usado na versão revisada: **“Traduzindo o Ser Humano — Da compreensão acumulada à presença que sustenta”.**

### Estado do artefato

- Formulário atualizado como rascunho salvo, não enviado.
- Alterações registradas nas páginas 2, 3, 6, 14 e 16.
