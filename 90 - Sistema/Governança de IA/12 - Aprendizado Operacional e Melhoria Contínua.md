...
| a carga inicial foi reduzida, mas a porta de estado ainda abria uma rota extensa e contraditória | medir também o contexto recuperado em tarefas recorrentes, não apenas a abertura geral | preservar a antiga porta como snapshot e substituir a versão ativa por entrada curta e coerente | rota de estado reduzida; verificador ampliado para impedir regressão |
